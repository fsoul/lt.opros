        ...
        <div class="int_b_content">
            ...
            <div class="form_row m_form">
                ...
                <div class="form_input">
                    ...
                    <input type="text" class="inp" id="inputPointsNumber" name="points_number" value="<%post:points_number%>"
            ...
            <div class="form_row">
                ...
                <div class="form_input mrgb20 m_form">
                    ...
                    <select class="inp inp_select" name="points_convertion_type" id="points_convertion_type"
                            onchange="start_convertion(document.forms['points_convertion'].points_convertion_type.value);"
                    >

                        <!--abc %dic_score_convert_type_list% -->

                        <option value=""><%iif::language,RU,Выберите способ конвертации, Виберіть спосіб конвертації%></option>
