<form action="#" method="post" name="changeEmail" class="m_form">
        ...
        <div class="int_b">
            <div class="int_b_content">
                ...
                <div class="int_b_text_form center">
                    ...
                    <input type="text" class="inp" id="inputEnterEmail" name="new_email" value="<%post:email_%>" placeholder="<%cms_cons:Login%>"/>
                    <div class="error">
