...
<form action="" method="post" name="registration" class="registration-form" id="mob_reg">
    ...
    <div class="main-wrap active-main-wrap">
        ...
        <div class="int_b_content">
            <input type="hidden" class="inputTxt" name="last_name_" id="last_name_" value="last_name" placeholder="<%e_cms_cons:Family%>">
        </div>
    ...
    <div class="main-wrap">
        ...
        <div class="int_b_content">
            ...
            <select class="inputTxt " name="region_" id="selector_region"
                ...
                <option value="<%e_cms_cons:Region%>"><%e_cms_cons:Region%></option>
            </select>
        ...
        <div class="int_b_content">
            ...
            <select class="inputTxt " name="city_" id="selector_city" onchange=""
                    title="Скористайтесь пунктом 'Iнший варiант' щоб ввести назву самостiйно">
                <option value="<%e_cms_cons:City%>"><%e_cms_cons:City%></option>
            </select>
        ...
        <a class="step4 button button-click click-next-window"><%iif::language,UA,От й познайомилися,Вот и познакомились%></a>
