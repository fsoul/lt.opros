    ...
    <div class="int_b_content">
      ...
      <div class="row">
        ...
        <div class="form_input m_form">
          <input type="text" class="inp" id="inputEnterEmail" name="login" value="<%post:login%>" placeholder="<%cms_cons:Login%>"
      ...
      <div class="row">
        ...
        <div class="form_input m_form">
          <input type="password" class="inp" id="inputEnterPassword" name="passw" placeholder="<%cms_cons:Password%>"
            onkeypress="if(checkEnter(event)) {try_login(document.getElementById('inputEnterEmail').value, 'internal_login_form'); return false;}"
          />
        </div>
      </div>

      <a class="button" href="<%get_href::t%>" onclick="try_login(document.getElementById('inputEnterEmail').value, 'internal_login_form'); return false;"><%cms_cons:Authorization%></a>
