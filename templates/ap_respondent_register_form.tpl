    ...
    <form method="POST" autocomplete="off">
        ...
        <div class="s_wrap">
            ...
            <div class="g_captcha inp_wrap clearfix">
                <div class="g-recaptcha r_float" data-sitekey="6LcLxjMUAAAAAJLddbOpUD0JchnD4OERO0hM06Zo" data-callback="imNotARobot" data-expired-callback="captchaExpired"></div>
            </div>
